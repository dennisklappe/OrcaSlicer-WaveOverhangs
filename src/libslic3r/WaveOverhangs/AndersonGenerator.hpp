...
///|/
#ifndef slic3r_WaveOverhangs_AndersonGenerator_hpp_
#define slic3r_WaveOverhangs_AndersonGenerator_hpp_

#include "IGenerator.hpp"

namespace Slic3r::WaveOverhangs {

class AndersonGenerator : public IGenerator {
public:
    GenerateResult generate(const ExPolygons   &overhang_area,
                            const Polygons     &lower_slices_polygons,
                            const CommonParams &params) override;
    const char *name() const override { return "anderson"; }
};
