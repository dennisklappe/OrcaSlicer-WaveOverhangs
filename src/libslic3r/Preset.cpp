...
static std::vector<std::string> s_Preset_print_options {
    ...
    "wave_overhangs", "wave_overhang_outer_perimeters",
    "wave_overhang_perimeter_overlap", "wave_overhang_narrow_split_threshold", "wave_overhang_pattern",
    "support_remaining_areas_after_wave_overhangs",
    "wave_overhang_line_spacing", "wave_overhang_line_width",
    "wave_overhang_print_speed", "wave_overhang_travel_speed", "wave_overhang_fan_speed",
    "wave_overhang_floor_layers",
    "wave_overhang_algorithm", "wave_overhang_laso_overlap", "wave_overhang_preset",
    ...
    "wave_overhang_wavefront_advance", "wave_overhang_discretization",
    "wave_overhang_andersons_max_iterations", "wave_overhang_min_new_area",
